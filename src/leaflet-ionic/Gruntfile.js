// Generated on 2014-12-02 using generator-ionic 0.6.1
'use strict';
...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    postcss: {
      options: {
        map: false,
        processors: [require('postcss-url')({
            url: function (url) {
              if (/^images/.test(url)) {
                url = '../' + url;
              }
      ...
      dist: { src: 'www/<%= yeoman.styles %>/*.css' }
    },
    htmlmin: {
      dist: {
        options: {
    ...
    rev: { files: { src: ['www/<%= yeoman.images %>/{,*/}*.{png,jpg,jpeg,gif,webp,svg}'] } },
    concurrent: {
      ionic: {
        tasks: [],
